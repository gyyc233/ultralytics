...
from ultralytics.utils.files import increment_path # 生成唯一的文件路径
...
def mouse_callback(event, x, y, flags, param):
    ...
    Mouse Events:
        - LBUTTONDOWN: Initiates dragging(拖动) for the region containing the clicked point.
        - MOUSEMOVE: Moves the selected region if dragging is active.
        - LBUTTONUP: Ends dragging for the selected region.

    Notes:
        - This function is intended to be used as a callback for OpenCV mouse events. 此函数旨在用作 OpenCV 鼠标事件的回调
...
def run(
    ...
    Args:
        ...
        line_thickness (int): Bounding box thickness. 线的粗细
